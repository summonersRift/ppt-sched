"""
 ...
 Obaida: This is copied from apps/snapsim/snapsim-mpi.py along with 'in' file as in_snapsim.dat
...
ncor = iparam['ncor']
"""
# we configure the app with constant parameters
nx = ny = nz =2
...
def snap_process(mpi_comm_world,  *args):
  """
